...
| Funders | **Liste** des financeurs du producteurs de données. Utile pour la déclaration de DOI ainsi que  pour produire  des  statistiques  sur les tutelles.<br />Un financeur est décrit de la manière suivante: **type:identifiantDeLOrganisation**.<br />Type = FrenchResearchInstitutes, FederativeStructure, ResearchUnit, Other, OtherUniversitiesAndSchools, ResearchProgram, FrenchUniversitiesAndSchools, OtherResearchInstitutes<br />identifianDeLOrganisation = valeur du champ *Identifier* de l'organisation correspondante dans le fichier organisation.csv. | non | FrenchResearchInstitutes:180006025_<br />FrenchResearchInstitutes:180089013_<br />FederativeStructure:200310841A_<br />FederativeStructure:200919527R_<br />FederativeStructure:200719584L |
|OnlineResource|Liste de valeurs permettant de décrire les ressources en ligne du producteur. Chacun des éléments de la liste sont préfixées par **http:**. Un élément et son url sont séparé par **@**. Les éléments renseignables les suivant:<br /> - **info** : Obligatoire. Cet élément de métadonnée fournit un lien vers le site web du producteur de données.<br /> - **download** : Cet  élément  de  métadonnée  fournit  un  lien  vers  le  portail  d'accès aux données du producteur de données. Cet élément est recommandé si une telle possibilité existe.<br /> - **doi** : Lien vers le DOI référencant de manière unique le producteur de données<br /> - **webservice** : Lien vers un webservice du producteur de données. Le webservice doit être décrit. La description est ajouté entre **crochet []** après **webservice** et avant le **@**. Il est possible de renseigner plusieurs éléments **webservice**<br />|oui | http:info@http://bd.amma-catch.org_<br />http:download@http://bd.amma-catch.org/download.jsf?lang=fr&identifier=29&stations=850,851,847,996,848,849&variables=29&begin=&end= _ <br />http:doi@http://dx.doi.org/10.17178/AMMA-CATCH.CE.Run_Nct _ <br />http:webservice[CSW getCapabilities]@http://localhost:8080/geoserver/csw?service=csw&version=2.0.2&request=GetCapabilities_<br />http:webservice[WMS getCapabilities]@http://sampleserver1.arcgisonline.com/ArcGIS/services/Specialty/ESRI_StatesCitiesRivers_USA/MapServer/WMSServer?version=1.3.0&amp;request=GetCapabilities&amp;service=WMS|
